...
/**
 * 80 题 · 每维 10 题。
 * 表述尽量短、口语、一事一句，降低理解成本。
 * reverse: true 为反向计分（答「同意」表示该倾向更低）。
 */
const QUESTIONS = [
  // ===== D1 国家形象防御 (1–10) =====
  { id: 1, dim: "D1", text: "在国外，如果有人提起中国的负面新闻，我更想马上纠正他们，而不是先听完。" },
  { id: 2, dim: "D1", text: "和外国人聊天时，我更愿意说中国进步了什么，而不是说还有什么问题。" },
  { id: 3, dim: "D1", text: "看到国产品牌、中国运动员在国外被夸，我会特别高兴，甚至比自己被夸还开心。" },
  { id: 4, dim: "D1", text: "如果国际上某个排名把中国排得很靠后，我会先怀疑这个排名不公平。" },
  { id: 5, dim: "D1", text: "同样是吐槽中国，中国人说我觉得正常；外国人说我会不太舒服。" },
  { id: 6, dim: "D1", text: "外国朋友当面说中国不好时，我会很想替中国辩护几句。" },
  { id: 7, dim: "D1", text: "我会在意外国人怎么看中国，而且这种在意挺强的。" },
  { id: 8, dim: "D1", text: "如果有人说中国「只会模仿、不会创新」，我会很想反驳。" },
  { id: 9, dim: "D1", text: "出国时被问到中国的敏感话题，我会先想「别让祖国丢脸」。" },
  { id: 10, dim: "D1", text: "外国媒体说中国不好时，我更愿意先听完，再判断有没有道理。", reverse: true },

  // ===== D2 对外群体敌意 (11–20) =====
  { id: 11, dim: "D2", text: "如果某国政府经常对中国不友好，我对那个国家的普通人也会多一份不信任。" },
  { id: 12, dim: "D2", text: "两国关系变差时，我会觉得对方国家大多数人并不真心希望中国好。" },
  { id: 13, dim: "D2", text: "外国人对中国的坏印象，多半是被他们本国媒体长期灌输的。" },
  { id: 14, dim: "D2", text: "两国闹矛盾时，我会主动少买那个国家的东西，也少看他们的影视。" },
  { id: 15, dim: "D2", text: "遇到一个说话很冲的外国人，我会忍不住觉得「他们那边的人都这样」。" },
  { id: 16, dim: "D2", text: "我不太相信某些对中国不友好的国家的普通人是真心友好的。" },
  { id: 17, dim: "D2", text: "抵制外国货，是一种很有效的表达态度的方式。" },
  { id: 18, dim: "D2", text: "我觉得很多外国人骨子里并不希望中国发展得太好。" },
  { id: 19, dim: "D2", text: "和对中国不友好的国家的人交朋友，我会有点别扭。" },
  { id: 20, dim: "D2", text: "即使两国关系不好，我仍愿意把对方普通人和政府分开看。", reverse: true },

  // ===== D3 批评者排斥 (21–30) =====
  { id: 21, dim: "D3", text: "身边总吐槽国内各种问题的人，我会觉得他们更多是在发牢骚。" },
  { id: 22, dim: "D3", text: "一个人如果很少说中国好、专挑问题，我会怀疑他的动机。" },
  { id: 23, dim: "D3", text: "碰到争议话题，我觉得大家先站在一起，比吵清楚道理更重要。" },
  { id: 24, dim: "D3", text: "已经把家人或资产放在国外的人，回来评论国内，说服力会打折扣。" },
  { id: 25, dim: "D3", text: "有人反复指出某项政策的负面效果，我会忍不住怀疑他是不是别有目的。" },
  { id: 26, dim: "D3", text: "网上那些天天骂中国的人，我觉得多半立场有问题。" },
  { id: 27, dim: "D3", text: "在公开场合，我更愿意和大家保持一致，而不是提出反对意见。" },
  { id: 28, dim: "D3", text: "对国内问题批评得特别狠的人，我会觉得他们不够建设性。" },
  { id: 29, dim: "D3", text: "讨论敏感话题时，我觉得「团结」比「说清楚」更重要。" },
  { id: 30, dim: "D3", text: "我认为认真批评国内问题的人，往往是在帮忙改进，不是在抹黑。", reverse: true },

  // ===== D4 体制绝对化认同 (31–40) =====
  { id: 31, dim: "D4", text: "中国这几年走的路子，很多发展中国家可以直接照着学。" },
  { id: 32, dim: "D4", text: "和欧美比，中国在办事效率、集中力量办大事上明显更强。" },
  { id: 33, dim: "D4", text: "社会上很多乱象，我觉得是执行的人没做好，不是规则本身有问题。" },
  { id: 34, dim: "D4", text: "讨论「中国要不要照搬西方式选举」意义不大，关键是把眼前这套用好。" },
  { id: 35, dim: "D4", text: "同等收入水平的国家里，中国这些年的发展速度应该是数一数二的。" },
  { id: 36, dim: "D4", text: "中国现行的做法，在大多数领域已经比多数国家更合适。" },
  { id: 37, dim: "D4", text: "很多社会问题，我觉得主要是下面执行歪了，上面设计其实没问题。" },
  { id: 38, dim: "D4", text: "中国的发展经验，对其他发展中国家很有参考价值。" },
  { id: 39, dim: "D4", text: "我觉得中国目前这套运行方式，整体上已经比较成熟了。" },
  { id: 40, dim: "D4", text: "我认为中国的发展路径还需要不断调整，不能简单当成模板。", reverse: true },

  // ===== D5 文化自卑与逆向民族 (41–50) =====
  { id: 41, dim: "D5", text: "在国外旅游时，我会觉得同胞的排队、音量、卫生习惯整体不如当地人。" },
  { id: 42, dim: "D5", text: "很多社会问题，我觉得根子是一种很难改掉的「国民性格」。" },
  { id: 43, dim: "D5", text: "论生活品味、审美和公共礼仪，发达国家整体还是高出一截。" },
  { id: 44, dim: "D5", text: "中国的电影、音乐、设计，总体还差口气，很难做到世界顶级。" },
  { id: 45, dim: "D5", text: "如果可以自由选长期居住地，我会更想去欧美国家，而不是留在北上广。" },
  { id: 46, dim: "D5", text: "我觉得中国人在公共场合的素质，整体上不如很多国家的人。" },
  { id: 47, dim: "D5", text: "很多国内乱象，我觉得是「我们这个民族」本身的问题。" },
  { id: 48, dim: "D5", text: "中国原创的文化产品，离世界一流还有明显距离。" },
  { id: 49, dim: "D5", text: "和外国人比，我会觉得自己人更爱占小便宜、更不守规矩。" },
  { id: 50, dim: "D5", text: "我并不觉得中国人在素质上天生不如别人，差距更多是环境造成的。", reverse: true },

  // ===== D6 外部制度理想化 (51–60) =====
  { id: 51, dim: "D6", text: "发达国家那种法治水平和社会信任，中国再发展几十年也很难达到。" },
  { id: 52, dim: "D6", text: "欧美在个人权利、公共讨论上的做法，整体上更接近我认为的「正常状态」。" },
  { id: 53, dim: "D6", text: "中国的教育、医疗对标日本或北欧，差距是结构性的，努力也难抹平。" },
  { id: 54, dim: "D6", text: "买进口货、看外文资料、用外资服务，我平均更放心一些。" },
  { id: 55, dim: "D6", text: "中国做成功的事，我更容易觉得是「特例」；外国做成功的事，我更容易觉得「本来就该这样」。" },
  { id: 56, dim: "D6", text: "把孩子送到国外读书，整体上还是比留在国内更稳妥。" },
  { id: 57, dim: "D6", text: "外国机构、外国品牌提供的东西，平均质量更高、更可靠。" },
  { id: 58, dim: "D6", text: "欧美社会的规则意识，更接近我认为的理想状态。" },
  { id: 59, dim: "D6", text: "中国在制度层面和发达国家比，差距很难靠努力追上。" },
  { id: 60, dim: "D6", text: "国外的做法值得参考，但中国也完全可以走出自己的好路径。", reverse: true },

  // ===== D7 归因双重标准 (61–70) =====
  { id: 61, dim: "D7", text: "同样的事故新闻，国内的我会更愤怒，国外的我会更容易找客观原因。" },
  { id: 62, dim: "D7", text: "国内出负面新闻，我先想该谁负责；国外出同样新闻，我先想当事人多不容易。" },
  { id: 63, dim: "D7", text: "中国某方面领先时，我会想「会不会只是短期」；外国领先时，我会想「这就是长期实力」。" },
  { id: 64, dim: "D7", text: "我发现自己对中外同类新闻的情绪反应，经常差得很远。" },
  { id: 65, dim: "D7", text: "对我喜欢的国家，我会自动多看好评；对我反感的国家，我会自动多看差评。" },
  { id: 66, dim: "D7", text: "同样是成绩，中国的我会想「是不是吹过头了」，外国的我会觉得「确实厉害」。" },
  { id: 67, dim: "D7", text: "国内出问题，我更容易骂；国外出同样问题，我更容易原谅。" },
  { id: 68, dim: "D7", text: "讨论问题时，我会不自觉地对中外用两套标准。" },
  { id: 69, dim: "D7", text: "我喜欢的国家出事，我会找理由；我不喜欢的国家出事，我会先下结论。" },
  { id: 70, dim: "D7", text: "我尽量用同一套标准看中外同类事件，尽量不双标。", reverse: true },

  // ===== D8 认知僵化与阴谋论 (71–80) =====
  { id: 71, dim: "D8", text: "国际上的大事，公开说的理由多半不是真正原因，背后一定还有别的。" },
  { id: 72, dim: "D8", text: "复杂的社会现象，我觉得抓住一两个关键原则就能解释清楚。" },
  { id: 73, dim: "D8", text: "和立场不同的人聊天时，我更常觉得对方「要么蠢要么坏」，而不是「角度不同」。" },
  { id: 74, dim: "D8", text: "如果出现足够有力的新证据，我愿意改变自己坚持很久的某个看法。" , reverse: true },
  { id: 75, dim: "D8", text: "很多标榜「中立客观」的说法，我觉得只是换了一种方式站队。" },
  { id: 76, dim: "D8", text: "世界上很多事情，背后都有人在操控，只是我们看不到。" },
  { id: 77, dim: "D8", text: "一旦我认定某件事，就很难再听进相反的说法。" },
  { id: 78, dim: "D8", text: "复杂问题往往没有简单答案，需要很多细节才能说清。", reverse: true },
  { id: 79, dim: "D8", text: "和我立场相反的人，多半不是被误导，就是别有用心。" },
  { id: 80, dim: "D8", text: "我觉得大多数「理性分析」，其实早就选好了结论。" },
];
...
function renderResult(result) {
  ...
  $("#result-type-lead").textContent =
    "以下结果基于你在 80 题上的作答。两个主指数并非互斥，交叉后得到整体画像。";
